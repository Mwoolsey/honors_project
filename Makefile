...
CXX = g++
MAIN = driver
CPP_FILES = main_menu.cpp message_handler.cpp char_select.cpp character.cpp images.cpp
H_FILES = main_menu.h message_handler.h char_select.h character.h images.h
O_FILES = main_menu.o message_handler.o char_select.o character.o images.o
